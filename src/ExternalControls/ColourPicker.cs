...
namespace ExternalControls
{
	...
	/// </summary>
	/// <remarks>
	/// This control simulates a combo-box style UI but drops down a <see cref="ExternalControls.ColorPanel">ColorPanel</see>
	...
	public class ColorPicker : System.Windows.Forms.UserControl
	{
		...
		private ExternalControls.ColorSortOrder panel_colorSortOrder   = ColorPanel.defaultColorSortOrder;
		private Size                       panel_colorWellSize    = ColorPanel.defaultColorWellSize;
		private ExternalControls.ColorSet       panel_colorSet         = ColorPanel.defaultColorSet;
		...
		/// contained <see cref="ExternalControls.ColorPanel">ColorPanel</see> is displayed.
		/// </remarks>
		/// <param name="e"></param>
		...
		/// <see cref="ExternalControls.ColorPanel">ColorPanel</see> control.<br></br><br></br>
		/// See <see cref="ExternalControls.ColorSet">ColorSet</see>.
		/// </summary>
		...
		public ExternalControls.ColorSet ColorSet
		{
			get
			{
		...
		/// <see cref="ExternalControls.ColorPanel">ColorPanel</see> should be sorted.<br></br><br></br>
		/// See <see cref="ExternalControls.ColorSortOrder">ColorSortOrder</see>.
		/// </summary>
		...
		public ExternalControls.ColorSortOrder ColorSortOrder
		{
			get
			{
