...
namespace ExternalControls
{
	...
	/// <br></br>
	/// <br></br>
	/// The set of colors displayed is controlled by the <see cref="ExternalControls.ColorSet">ColorSet</see> property.
	/// </remarks>
	public class ColorPanel : System.Windows.Forms.UserControl
	{
		...
		public ExternalControls.ColorSet ColorSet
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSet", value, typeof(ExternalControls.ColorSet) );
		...
		public ExternalControls.ColorSortOrder ColorSortOrder
		{
			...
			set
			{
				Utils.CheckValidEnumValue( "ColorSortOrder", value, typeof(ExternalControls.ColorSortOrder) );
