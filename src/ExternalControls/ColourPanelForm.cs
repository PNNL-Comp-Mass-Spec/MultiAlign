...
namespace ExternalControls
{
	...
	{
		private ExternalControls.ColorPanelWithCapture colorPanel = null;
		...
		{
			this.colorPanel = new ExternalControls.ColorPanelWithCapture();
			this.SuspendLayout();
			// 
			// colorPanel
			// 
			...
			this.colorPanel.ColorSet = ExternalControls.ColorSet.Web;
			this.colorPanel.ColorSortOrder = ExternalControls.ColorSortOrder.Brightness;
			...
			this.colorPanel.ColorChanged += new ExternalControls.ColorChangedEventHandler(this.colorPanel_ColorChanged);
			this.colorPanel.PanelClosing += new ExternalControls.ColorPanelClosingEventHandler(this.colorPanel_PanelClosing);
		...
		private void colorPanel_ColorChanged(object sender, ExternalControls.ColorChangedEventArgs e)
		{
