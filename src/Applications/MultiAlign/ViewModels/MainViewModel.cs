...
namespace MultiAlign.ViewModels
{
    ...
    public sealed class MainViewModel : ViewModelBase
    {
        ...
        /// <param name="e"></param>
        private void LoadingAnalysisViewModel_AnalysisLoaded(object sender, AnalysisStatusArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void GettingStartedViewModel_ExistingAnalysisSelected(object sender, OpenAnalysisArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void GettingStartedViewModel_NewAnalysisStarted(object sender, OpenAnalysisArgs e)
        {
        ...
        private void AnalysisRunningViewModel_AnalysisCancelled(object sender, EventArgs e)
        {
            StateModerator.CurrentViewState = ViewState.HomeView;
            StateModerator.CurrentAnalysisState = AnalysisState.Idle;
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AnalysisSetupViewModel_AnalysisQuit(object sender, EventArgs e)
        {
            CancelAnalysisSetup();
        }
