...
namespace MultiAlign.ViewModels.Wizard
{
    ...
    {        
        ...
        public double HistogramBinWidth
        {
            get
            {
                return m_options.HistogramBinWidth ;
            }
            set
            {
        ...
        public double HistogramMultiplier  
        {
            get
            {
                return m_options.HistogramMultiplier ;
            }
            set
            {
        ...
        public bool ShouldCalculateHistogramFdr
        {
            get
            {
                return m_options.ShouldCalculateHistogramFDR;
            }
            set
            {
        ...
        public bool ShouldCalculateShiftFdr
        {
            get
            {
                return m_options.ShouldCalculateShiftFDR ;
            }
            set
            {
        ...
        public bool ShouldCalculateSliC  
        {
            get
            {
                return m_options.ShouldCalculateSLiC;
            }
            set
            {
        ...
        public bool ShouldCalculateStac
        {
            get
            {
                return m_options.ShouldCalculateSTAC;
            }
            set
            {
        ...
        public double DriftTimeTolerance 
        {
            get
            {
                return m_options.DriftTimeTolerance;
            }
            set
            {
        ...
        public double MassTolerancePpm 
        {
            get
            {
                return m_options.MassTolerancePPM;
            }
            set
            {
