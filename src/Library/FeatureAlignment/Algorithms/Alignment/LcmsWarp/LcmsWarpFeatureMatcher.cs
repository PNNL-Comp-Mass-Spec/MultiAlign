...
namespace FeatureAlignment.Algorithms.Alignment.LcmsWarp
{
    ...
    public class LcmsWarpFeatureMatcher
    {
        ...
        public List<LcmsWarpFeatureMatch> GetMatchesAs(SeparationTypes separationType)
        {
        ...
        public void GenerateCandidateMatches(List<UMCLight> aligneeFeatures, List<UMCLight> baselineFeatures, IEnumerable<SeparationTypes> separationTypes = null)
        {
