...
namespace Cephes
{
	public class clsMathUtilities
	{
		...
		public static void LinearRegression(double [] X, double [] Y, ref double slope, ref double intercept, ref double rsquare)
		{
		...
		/// For small arguments 0 < y < exp(-2), the program computes z = sqrt( -2.0 * Math.Log(y) );  then the approximation is
		...
		{
			double a=0 , b=0 , y0 =0 , d=0 , y=0, x=0, x0=0, x1=0, lgm=0, yp=0, di=0, dithresh=0, yl=0, yh=0, xt=0;
