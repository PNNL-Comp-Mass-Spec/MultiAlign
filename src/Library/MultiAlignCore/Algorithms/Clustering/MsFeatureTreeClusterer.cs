...
namespace MultiAlignCore.Algorithms.Clustering
{
    ...
    public class MsFeatureTreeClusterer<TChildFeature, TParentFeature>
        ...
        where TParentFeature: UMCLight, Data.Features.IFeatureCluster<TChildFeature>, Data.Features.IFeatureCluster<TParentFeature>, new ()
        ...
        
    {
        ...
        private IEnumerable<TCluster> Cluster<TChild, TCluster>( IEnumerable<TChild>             features, 
                ...
                where TCluster: FeatureLight, Data.Features.IFeatureCluster<TChild>, new ()
        {
