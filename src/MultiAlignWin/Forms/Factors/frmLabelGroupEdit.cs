...
namespace MultiAlignEngine.Forms.Factors
{
	public class frmLabelGroupEdit : PNNLControls.frmDialogBase
	{
		...
		private void UpdatePreview()
		{
			...
			classFactorTree tree	= new classFactorTree();
			tree = m_factorTree.Clone() as classFactorTree;
			classTreeNode node	= BuildTree(ref tree);			

			PNNLControls.clsLabelAttributes root = new clsLabelAttributes();
			classTreeNodeConverter converter = new classTreeNodeConverter();
