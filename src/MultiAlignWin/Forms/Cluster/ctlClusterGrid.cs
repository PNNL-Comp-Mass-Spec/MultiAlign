...
namespace MultiAlignWin
{
	...
	public class ctlClusterGrid : ECsoft.Windows.Forms.DataGridEx 
    {
        ...
        private void mnu_save_sqlite_Click(object sender, EventArgs e)
        {
			...
			// Set DB Location
            NHibernateUtil.SetDbLocationForWrite(fileDialog.FileName);
			...
			clsMassTag[] massTagArray = mobjAnalysis.PeakMatchingResults.marrMasstags;
			clsProtein[] proteinArray = mobjAnalysis.PeakMatchingResults.marrProteins;
			...
			if (mobjAnalysis.PeakMatchedToMassTagDB)
			{
				foreach (clsPeakMatchingResults.clsPeakMatchingTriplet triplet in mobjAnalysis.PeakMatchingResults.marrPeakMatchingTriplet)
				{
