...
namespace MultiAlignWin.Data
{
    ...
    public class clsDMSServerInformation 
    {
        ...
        {
            mint_connectionTimeout  = Properties.Settings.Default.DMSConnectionTimeout;
            mstring_dmsServerName   = Properties.Settings.Default.DMSServerName;
            mstring_databaseName    = Properties.Settings.Default.DMSDatabaseName;
            mstring_username        = "dmswebuser";
            mstring_password        = "icr4fun";
            mbool_hasConnectionToDMS = false;
        }
        /// <summary>
        ...
        public string ServerName
        {
            get
            {
                return mstring_dmsServerName;
            }
            set
            {
                mstring_dmsServerName = value;
            }
        }
        /// <summary>
        ...
        public int ConnectionTimeout
        {
            get
            {
                return mint_connectionTimeout;
            }
            set
            {
                mint_connectionTimeout = value;
            }
        }
        /// <summary>
        ...
        public string DatabaseName
        {
            get
            {
                return mstring_databaseName;
            }
            set
            {
                mstring_databaseName = value; 
            }
        }
        /// <summary>
        ...
        public bool ConnectionExists
        {
            get
            {
                return mbool_hasConnectionToDMS;
            }
            set
            {
                mbool_hasConnectionToDMS = value;
            }
        }
        #endregion
    }
