...
namespace MultiAlignTestSuite.Algorithms.Alignment.LCMSWarp
{
    ...
    public class MtdbFileReaderTest
    {
                                ...
                                string path2)
        {
            ...
            var rawBaselineData = System.IO.File.ReadAllLines(datasetOnePath);
            var rawFeaturesData = System.IO.File.ReadAllLines(datasetTwoPath);
            ...
            for(var i = 0; i < baseline.Count; i++)
            {
                ...
                Assert.IsTrue(Math.Abs(baseline[i].MassMonoisotopicAligned - txtbaseline[i].MassMonoisotopicAligned) < 0.0000000001);
            }
        }
    }
}